...
Begin VB.Form FrmRelVdaGru 
   ...
   End
End
Attribute VB_Name = "FrmRelVdaGru"
...
Private Sub Relatorio_ImprimiuRegistro(Cancelar As Boolean)
    ...
    SomaValor = SomaValor + Relatorio.Recordset("SomaDeValor") ' - Relatorio.Recordset("SomaDesconto"))
    SomaVlrVdaDia = SomaVlrVdaDia + Relatorio.Recordset("SomaDeVlrVdaDia") ' - Relatorio.Recordset("SomaDesconto"))
