...
Begin VB.Form FrmRelComiss01 
   ...
   End
End
Attribute VB_Name = "FrmRelComiss01"
...
Private Sub Relatorio_ImprimiuRegistro(Cancelar As Boolean)
    ...
    If Relatorio.Recordset("Valor") <> 0 Then
        VarPerc = ((Relatorio.Recordset("SomaDeComissao") + Relatorio.Recordset("Valor")) / Relatorio.Recordset("Total")) * 100
    End If
