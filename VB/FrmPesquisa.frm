...
If VarPcoPrazo = True Then
    Datdados.RecordSource = "SELECT Prd.Codbar, PRD.complemento, PRD.CodPrd, PRD.Descrição_Produto, PRD.Venda, Prd.Margem, Prd.Custo, Prd.Ativo, Prd.Obs, Prd.PcoPrazo as Expr1, PRD.Estoque , Prd.CodAbc, Prd.Promocao, Prd.Venda_Promocao FROM PRD WHERE Prd.Ativo = True ORDER BY PRD.Descrição_Produto"
Else
    Datdados.RecordSource = "SELECT Prd.Codbar, PRD.complemento, PRD.CodPrd, PRD.Descrição_Produto, PRD.Venda, Prd.Margem, Prd.Custo,Prd.Ativo, Prd.Obs, [prd].[venda]+([prd].[venda]*(" & Replace(Ind, ",", ".") & "/100)) AS Expr1, PRD.Estoque , Prd.CodAbc FROM PRD WHERE Prd.Ativo = True ORDER BY PRD.Descrição_Produto"
End If
Datdados.Refresh
TxtPesquisa = ""
...
If Datdados.Recordset.RecordCount > 0 Then
    FrmPedidos.DbcDados(1) = Datdados.Recordset.Fields(2)
    Unload Me
    FrmPedidos.DbcDados(1).SetFocus
End If
End Sub
...
'    Else
        If VarPcoPrazo = True Then
            Datdados.RecordSource = "SELECT Prd.Codbar, PRD.complemento, PRD.CodPrd, PRD.Descrição_Produto, Prd.Margem,PRD.Venda, Prd.Custo, Prd.Obs, Prd.PcoPrazo as Expr1 , PRD.Estoque , Prd.CodAbc, Prd.Promocao, Prd.Venda_Promocao FROM PRD WHERE Prd.Ativo = True AND PRD.complemento LIKE  " & """" & TxtPesquisa & """" & " ORDER BY PRD.Descrição_Produto"
        Else
            Datdados.RecordSource = "SELECT Prd.Codbar, PRD.complemento, PRD.CodPrd, PRD.Descrição_Produto, Prd.Margem,PRD.Venda, Prd.Custo, Prd.Obs, [prd].[venda]+([prd].[venda]*(" & Replace(Ind, ",", ".") & "/100)) AS Expr1, PRD.Estoque , Prd.CodAbc FROM PRD WHERE Prd.Ativo = True AND PRD.complemento LIKE  " & """" & TxtPesquisa & """" & " ORDER BY PRD.Descrição_Produto"
        End If
        Datdados.Refresh
        BtCont.Caption = Datdados.Recordset.RecordCount
 '   End If
...
'If Datdados.Recordset.RecordCount >= 0 And x = True Then
    ...
    Else
        If TxtPesquisa <> "" Then
            ...
            If Left(TxtPesquisa, 1) = "*" Or Right(TxtPesquisa, 1) = "*" Then
                If Len(TxtPesquisa) > 1 Then
                    ...
                    Else
                        Datdados.RecordSource = "SELECT Prd.Codbar, PRD.complemento, PRD.CodPrd, PRD.Descrição_Produto, Prd.Margem,PRD.Venda, Prd.Custo, Prd.Obs, [prd].[venda]+([prd].[venda]*(" & Replace(Ind, ",", ".") & "/100)) AS Expr1, PRD.Estoque , Prd.CodAbc FROM PRD WHERE Prd.Ativo = True AND PRD.Descrição_Produto LIKE  " & """" & TxtPesquisa & """" & " ORDER BY PRD.Descrição_Produto"
                    End If
                    Datdados.Refresh
                    BtCont.Caption = Datdados.Recordset.RecordCount
                End If
        ...
        Else
            If VarPcoPrazo = True Then
                Datdados.RecordSource = "SELECT Prd.Codbar, PRD.complemento, PRD.CodPrd, PRD.Descrição_Produto, Prd.Margem,PRD.Venda, Prd.Custo, Prd.Ativo, Prd.Obs, Prd.PcoPrazo as expr1, PRD.Estoque , Prd.CodAbc, Prd.Promocao,  Prd.Venda_Promocao FROM PRD WHERE Prd.Ativo = True AND Prd.CodPrd = 0 ORDER BY PRD.Descrição_Produto"
            Else
                Datdados.RecordSource = "SELECT Prd.Codbar, PRD.complemento, PRD.CodPrd, PRD.Descrição_Produto, Prd.Margem,PRD.Venda,Prd.Custo, Prd.Ativo, Prd.Obs, [prd].[venda]+([prd].[venda]*(" & Replace(Ind, ",", ".") & "/100)) AS Expr1, PRD.Estoque , Prd.CodAbc FROM PRD WHERE Prd.Ativo = True AND Prd.CodPrd = 0 ORDER BY PRD.Descrição_Produto"
            End If
            Datdados.Refresh
        End If
    End If
...
'            Criterio = Criterio & Terminacao & txtPesquisa & Terminacao
        ...
        Datdados.Recordset.FindFirst Criterio
        If VarPcoPrazo = True Then
            Datdados.RecordSource = "SELECT Prd.Codbar, PRD.complemento, PRD.CodPrd, PRD.Descrição_Produto, PRD.Venda,Prd.Margem, Prd.Custo, Prd.Obs, Prd.PcoPrazo as Expr1 , PRD.Estoque , Prd.CodAbc,Prd.Promocao, Prd.Venda_Promocao FROM PRD WHERE Prd.Ativo = True AND PRD.CodPrd =  " & TxtPesquisa & " ORDER BY PRD.Descrição_Produto"
        Else
            Datdados.RecordSource = "SELECT Prd.Codbar, PRD.complemento, PRD.CodPrd, PRD.Descrição_Produto, PRD.Venda,Prd.Margem, Prd.Custo, Prd.Obs, [prd].[venda]+([prd].[venda]*(" & Replace(Ind, ",", ".") & "/100)) AS Expr1, PRD.Estoque , Prd.CodAbc FROM PRD WHERE Prd.Ativo = True AND PRD.CodPrd =  " & TxtPesquisa & " ORDER BY PRD.Descrição_Produto"
        End If
        Datdados.Refresh
        BtCont.Caption = Datdados.Recordset.RecordCount
