...
Begin VB.Form FormGrupo 
   ...
   Begin VB.Data Datdados 
      ...
      RecordSource    =   "Select * FROM Gru ORDER BY CodGru"
      Top             =   3735
      Visible         =   0   'False
      Width           =   2355
   End
   Begin MSDBGrid.DBGrid DbgIndices 
      Bindings        =   "FormGrupo.frx":0000
      Height          =   5190
      Left            =   135
      OleObjectBlob   =   "FormGrupo.frx":001A
      TabIndex        =   0
      Top             =   675
      Width           =   7305
   End
End
Attribute VB_Name = "FormGrupo"
