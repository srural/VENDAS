...
Begin VB.Form FrmRelPrdGru 
   ...
   End
End
Attribute VB_Name = "FrmRelPrdGru"
...
Private Sub Relatorio_FormulaCampo(ByVal Campo As String, Valor As Variant)
    If Campo = "forPrazo" Then
        ...
        End If
    End If
    If Campo = "forAtacado" Then
        Valor = Relatorio.Recordset("Margem_Concorrencia")
    End If
    
    If Campo = "forGelado" Then
        Valor = Relatorio.Recordset("Venda_Concorrencia")
    End If
