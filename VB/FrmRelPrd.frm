...
Private Sub Relatorio_FormulaCampo(ByVal Campo As String, Valor As Variant)
    ...
    If Campo = "forPromocao" Then
        'If Relatorio.Recordset("Promocao") = True Then
        '    Valor = Relatorio.Recordset("Venda_Promocao")
        'Else
        '    Valor = 0
        'End If
        
        Valor = Relatorio.Recordset("Validade")
    End If
