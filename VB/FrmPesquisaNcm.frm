...
Begin VB.Form FrmPesquisaNcm 
   BackColor       =   &H00C0C0C0&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Pesquisa de NCM"
   ClientHeight    =   5295
   ClientLeft      =   720
   ClientTop       =   2355
   ClientWidth     =   11685
   ...
   Begin VB.Data DatDados 
      ...
      RecordSource    =   "SELECT CadNcm.Descricao, CadNcm.Categoria, CadNcm.NCM, CadNcm.Inicio, CadNcm.Fim FROM CadNcm ORDER BY CadNcm.Descricao"
      Top             =   2880
      Visible         =   0   'False
      Width           =   2655
   End
   ...
   Begin MSDBGrid.DBGrid DBGProdutos 
      Bindings        =   "FrmPesquisaNcm.frx":0000
      Height          =   4515
      Left            =   180
      OleObjectBlob   =   "FrmPesquisaNcm.frx":0017
      TabIndex        =   1
      Top             =   585
      Width           =   11205
   End
End
Attribute VB_Name = "FrmPesquisaNcm"
...
'    FormProdutos.TxtDados(10) = DatDados.Recordset.Fields(0)
    If DatDados.Recordset.Fields("NCM") <> "" Then
        FormProdutos.TxtDados(7) = DatDados.Recordset.Fields("NCM")
    Else
...
DatDados.RecordSource = "SELECT CadNcm.Descricao, CadNcm.NCM, CadNcm.Inicio, CadNcm.Fim FROM CadNcm ORDER BY CadNcm.Descricao"
...
Terminacao = """"
If TxtPesquisa <> "" Then
    DatDados.RecordSource = "SELECT CadNcm.Descricao, CadNcm.NCM, CadNcm.Inicio, CadNcm.Fim FROM  CadNcm WHERE  Descricao like " & """" & "*" & TxtPesquisa & "*" & """" & "ORDER BY CadNcm.Descricao"
    DatDados.Refresh
