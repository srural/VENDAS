...
Begin VB.Form FormBaixarDupli 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "FormBaixarDupli.frx":0000
      ...
      TabPicture(1)   =   "FormBaixarDupli.frx":001C
      ...
      TabPicture(2)   =   "FormBaixarDupli.frx":0038
      ...
      Begin MSDBGrid.DBGrid dbgrid1 
         Bindings        =   "FormBaixarDupli.frx":0054
         Height          =   3945
         Left            =   -74910
         OleObjectBlob   =   "FormBaixarDupli.frx":006E
         TabIndex        =   42
         Top             =   360
         Width           =   13605
      End
   ...
   Begin VB.Frame FrmEnt 
      ...
      Begin MSDBCtls.DBCombo DbcPesquisa 
         Bindings        =   "FormBaixarDupli.frx":2341
         DataField       =   "Nome"
         Height          =   315
         Left            =   180
         TabIndex        =   0
   ...
   Begin VB.ComboBox LstTipo 
      Appearance      =   0  'Flat
      Height          =   315
      ItemData        =   "FormBaixarDupli.frx":235B
      Left            =   1680
      List            =   "FormBaixarDupli.frx":2371
      TabIndex        =   10
      Top             =   7155
      Width           =   2580
   End
...
'                Open "c:\lixo.txt" For Output As #1
        ...
        '                    Print #1, " "
                    ...
                    End If
                Else
                    If MsgBox("Imprimir duas vias ?", vbYesNo) = vbYes Then
                        VarVias = 2
                    Else
                        VarVias = 1
                    End If
        ...
        Else
            ...
            If ChkJuros Then
                If VarMulta = True Then
                    If DatDados(0).Recordset.Fields("DtVenc") < (Date - 15) Then
                        Prazo = (Date - 15) - DatDados(0).Recordset.Fields("DtVenc")
                        DatDados(0).Recordset.Edit
...
'                        If DatDados(0).Recordset.Fields("DtVenc") < Date - 30 Then
