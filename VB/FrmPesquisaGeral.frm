...
Begin VB.Form FrmPesquisaGeral 
   BorderStyle     =   1  'Fixed Single
   ClientHeight    =   6405
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   8715
   Icon            =   "FrmPesquisaGeral.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6405
   ...
   End
End
Attribute VB_Name = "FrmPesquisaGeral"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Public Pesquisa As Recordset  'ado de pesquisa
...
'    End If
    ...
    Set Pesquisa = Banco.OpenRecordset(SqlPesquisa)     ', Banco, adOpenStatic, adLockOptimistic, adCmdText
    Pesquisa.Requery
    Pesquisa.MoveLast
    Pesquisa.MoveFirst
...
While Not Pesquisa.Eof
    ...
    End If
'   Set lstPesq = lvPesquisa.ListItems.Add(, , Pesquisa!CodEntidade)

'   lstPesq.SubItems(1) = Pesquisa!CodEntidade
'   lstPesq.SubItems(2) = Pesquisa!Nome
...
'        Formulário.Retorno.Text = LvPesquisa2.SelectedItem.Text
'        Formulário.RetornoPesq = lvPesquisa.SelectedItem.Text
        Formulário.RetornoPesq = lvPesquisa.ListItems.Item(lvPesquisa.SelectedItem.Index).ListSubItems(1).Text
