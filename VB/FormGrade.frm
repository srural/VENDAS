...
Begin VB.Form FormGrade 
   BorderStyle     =   1  'Fixed Single
   ClientHeight    =   5580
   ClientLeft      =   2010
   ClientTop       =   1860
   ClientWidth     =   4065
   Icon            =   "FormGrade.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin MSDBGrid.DBGrid DBGrid1 
      Bindings        =   "FormGrade.frx":000C
      Height          =   3705
      Left            =   180
      OleObjectBlob   =   "FormGrade.frx":0026
      TabIndex        =   4
      Top             =   810
      Width           =   3480
   End
End
Attribute VB_Name = "FormGrade"
...
DatDados(0).RecordSource = "SELECT  Produto, DescricaoLoja, Estoque, CodBarLoja FROM LOJ WHERE (((Produto)=" & FrmPedidos.DbcDados(1).BoundText & " )) ORDER BY DescricaoLoja"
DatDados(0).Refresh
