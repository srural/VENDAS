...
Begin VB.Form FrmRelCarnePromi3 
   ...
   Begin ReportX.ReportSection SecPromissoria 
      ...
      Begin ReportX.ReportField R4 
         ...
         EndProperty
      End
      Begin ReportX.ReportField RpNomeCarne 
         Height          =   240
         Left            =   180
         TabIndex        =   121
         Top             =   675
      ...
      Begin VB.Label Label56 
         Alignment       =   2  'Center
         BackStyle       =   0  'Transparent
         Caption         =   "juros de mora e outras despesas."
         Height          =   195
         Left            =   180
         TabIndex        =   135
         Top             =   4500
      ...
      Begin VB.Label Label55 
         Alignment       =   2  'Center
         BackStyle       =   0  'Transparent
         Caption         =   " no vencimento, não dispensar "
         Height          =   240
         Left            =   180
         TabIndex        =   134
         Top             =   4320
   ...
   End
End
Attribute VB_Name = "FrmRelCarnePromi3"
