...
Begin VB.Form FormAutoriza 
   ...
   Begin MSDBCtls.DBCombo CmbFunc 
      Bindings        =   "FormAutoriza.frx":0000
      DataSource      =   "DatUsu"
      Height          =   315
      Left            =   3285
      TabIndex        =   26
   ...
   Begin VB.Data DatDados 
      ...
      ReadOnly        =   -1  'True
      RecordsetType   =   1  'Dynaset
      RecordSource    =   $"FormAutoriza.frx":0015
      Top             =   4860
      Visible         =   0   'False
      Width           =   1860
   End
   Begin MSDBGrid.DBGrid Grid 
      Bindings        =   "FormAutoriza.frx":010B
      Height          =   2475
      Left            =   225
      OleObjectBlob   =   "FormAutoriza.frx":0125
      TabIndex        =   5
      Top             =   3105
      Width           =   10770
   End
   ...
   End
End
Attribute VB_Name = "FormAutoriza"
...
If DatDados(1).Recordset.RecordCount > 0 Then
    ...
    Print #2, "01" & Trim(VarUsuario) & Trim(CmbFunc) & Trim(VarChave)
...
Private Sub DatUsu_Reposition()
If DatUsu.Recordset.Fields("Senha") <> "" Then
    CmbFunc = DatUsu.Recordset("Cpf")
    TxtSenha = DatUsu.Recordset("Senha")
End If
End Sub
...
Wend
    While FileLen("C:\FPOPULAR\FP_REQ.txt") = 0
 '   DoEvents
    Wend
'End If
