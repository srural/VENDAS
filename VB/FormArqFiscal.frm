...
Begin VB.Form FormArqFiscal 
   ...
   Begin VB.ComboBox CmbMes 
      Appearance      =   0  'Flat
      Height          =   315
      ItemData        =   "FormArqFiscal.frx":0000
      Left            =   360
      List            =   "FormArqFiscal.frx":0028
   ...
   End
End
Attribute VB_Name = "FormArqFiscal"
...
ArqCompactadoSat = PortaAcbr & "\Arqs\Sat\Vendas\" & VarCnpjEmite & "\" & Trim(Str(Year(Date))) & psCompString(1, CmbMes.ListIndex + 1, 2) & "-Sat.zip"
